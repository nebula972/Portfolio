									...
									<!-- Content -->
										<article class="box page-content">
											...
											<section>
												...
												<form method="POST" action="https://formspree.io/f/xpzeleqo" name="form_contact">
													<input type="text" name="input_nomprenom" placeholder="Nom et Prénom">
													<input type="email" name="input_email" placeholder="E-mail">
													<div class="form-group">
													<div class="form-group">
													<textarea is="textarea-autogrow"  name="textarea_message" rows="7" placeholder="Ecrivez votre message ici..."></textarea>
